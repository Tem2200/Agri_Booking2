...
//     ),
//     const SizedBox(width: 12),
//     Expanded( // ✅ บังคับให้ข้อความอยู่ในพื้นที่ Row ไม่ล้นออกไป
//       child: Text(
//         member['username'] ?? '-',
...
//         overflow: TextOverflow.visible, // ✅ ไม่ตัดทิ้ง
//       ),
//     ),
//   ],
// ),
...
class _HomePageState extends State<HomePage> {
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 8),
                                  _buildInfoRow(
                                    icon: const Icon(Icons.email, size: 18, color: Colors.redAccent),
                                    text: member['email'] ?? '-',
                                  ),
                                  const SizedBox(height: 8),
                                  _buildInfoRow(
                                    icon: const Icon(Icons.chat, size: 18, color: Colors.deepOrange),
                                    text: (member['other'] != null &&
                                            member['other'].toString().trim().isNotEmpty)
                                        ? member['other']
                                        : '-',
                                  ),
                                  const SizedBox(height: 8),
                                  _buildLocationRow(
                                    icon: const Icon(Icons.location_on, size: 18, color: Colors.orange),
                                    address: member['detail_address'] ?? '-',
  ...
  child: Column(
    ...
    mainAxisSize: MainAxisSize.min,
    children: [
      // ชื่อรถ ตัด ... ถ้ายาวเกิน 1 บรรทัด
      Text(
        vehicle['name_vehicle'] ?? 'ไม่มีชื่อรถ',
        style: const TextStyle(
          fontSize: 16,
      ...
      // รายละเอียด ตัด ... ถ้ายาวเกิน 1 บรรทัด
      Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
        ...
        children: [
          ...
          Flexible(
            child: Text(
              ...
              softWrap: true,  // ให้ขึ้นบรรทัดใหม่
            ),
          ),
        ],
      ),
        ...
        children: [
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => Detailvehicle(vid: vid),
                  ),
                );
              },
              child: Text(
          ...
          Column(
            children: [
              ...
              Text(
                currentStatus ? 'ให้บริการ' : 'งดให้บริการ',
                style: TextStyle(
                  fontWeight: FontWeight.bold,
                  fontSize: 12,
  ...
  Widget _buildInfoRow({required Icon icon, required String text}) {
    return Container(
